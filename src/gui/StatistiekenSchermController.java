...
public StatistiekenSchermController() {
	...
	private void initializeData() {
		...
		lblKlanten.setText(String.format("Totaal aantal klanten: %d%nActief: %d%nNiet actief:%d", alleKlanten,actieveKlanten,inactieveKlanten));
		...
		lblWerknemers.setText(String.format("Totaal aantal Werknemers: %d%nActief: %d%nInactief: %d", alleWerknemers,actieveWerknemers,inactieveWerknemers));
